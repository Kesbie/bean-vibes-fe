...
import { restrictedWordService, userService } from "@/services";
...
const UsersPage = () => {
  ...
  const { mutate: addRestrictedWord } = useCustomMutation({
    mutationFn: (payload: App.Types.User.UserCreate) =>
  ...
  const { mutate: updateRestrictedWord } = useCustomMutation({
    mutationFn: (payload: App.Types.User.UserResponse) =>
  ...
  const handleFinish: App.Components.FormAdvance.OnFinishEvent<App.Types.User.UserCreate> =
    React.useCallback(
      (info) => {
  ...
  const handleDelete = React.useCallback(
    (value: App.Types.User.UserResponse) => {
  ...
  const handleEdit = React.useCallback(
    (values: App.Types.User.UserResponse) => {
  ...
  const renderAction = React.useCallback(
    (record: App.Types.User.UserResponse) => {
      return (
        <>
          <Button
            danger
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      />
      <Table<App.Types.User.UserResponse>
